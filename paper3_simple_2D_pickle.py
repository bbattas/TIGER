...
def para_volume_calc(time_step,i,t_frames,dimension_case,op_max,file_name):
    """
...
if __name__ == "__main__":
    ...
    for cnt,file_name in enumerate(file_names):
        ...
        # Parallel calculation
            ...
            results = Parallel(n_jobs=cl_args.cpus)(delayed(para_volume_calc)(frame, i, t_frames, dimcase, op_max, file_name) for i, frame in enumerate(tqdm(idx_frames)))
