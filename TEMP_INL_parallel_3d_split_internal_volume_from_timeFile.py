# TEMPORARY internal pore plotting for the large complex structures on Sawtooth
# Needs to either replace the closest to 0,0,0 with 0,0,0 or just add 0,0,0
# Needs to be split calculation so it can run on ~2000 cpu nemesis files
...
def para_volume_calc(time_step,i,op_max):
    ...
    if quarter_hull == True:
        print("Adding (0,0,0) to centroids")
        # Move the minimum centroid?
